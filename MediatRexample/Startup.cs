...
namespace MediatRexample
{
    public class Startup
    {
        ...
        /**
         * Seed para ter dados de exemplo
         */
        private void SeedInMemoryDatabase(IApplicationBuilder app)
        {
            using(var serviceScope = app.ApplicationServices.CreateScope())
            {
                var context = serviceScope.ServiceProvider.GetService<ContractContext>();
